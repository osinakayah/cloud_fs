...
class Widget01 extends Component {
    render() {
        const {restoreFileOrFolder, openFolder, className, cssModule, header, mainText, icon, color, footer, link, children, variant, ...attributes} = this.props;
            ...
            if(footer){
                ...
                return (
                    <CardFooter className="px-3 py-2">
                        <Button onClick={() => restoreFileOrFolder(link)} className="font-weight-bold font-xs btn-block text-muted">Restore
